...
class categoryclass:
    def __init__(self,root):
        ...
        ###########title######
        lbl_title=Label(self.root,text="Manage Product Category",font=("goudy old style ",30),bg="darkorange",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)
        ...
        btn_add=Button(self.root,text="ADD",command=self.add,font=("goudy old style ",15),bg="#4caf50",fg="white",cursor="hand2").place(x=360,y=170,width=150,height=40)
        btn_del=Button(self.root,text="Delete",command=self.delete,font=("goudy old style ",15),bg="red",fg="white",cursor="hand2").place(x=520,y=170,width=150,height=40)
        ...
        #########3images##
        self.im1=Image.open("images/supply.png")
